...
def _build_full_pipeline_preview(
    *,
    ...
    result = {
        ...
        "model_logic": {
            **model_logic,
            "preview_source": "run_full_generation_pipeline_before_grooves",
            "canonical_note": "preview is generated by the same full 3D pipeline as production model generation, exported before groove/paz boolean cutting",
