...
def _build_full_pipeline_preview(
    *,
    ...
    request_ns.skip_road_hole_audit = False
    request_ns.skip_layer_overlap_audit = False
    request_ns.skip_canonical_printability_audit = False
    ...
    result = {
        ...
        "model_logic": {
            **model_logic,
            ...
            "canonical_note": "preview is generated by the same full 3D geometry pipeline as production model generation; groove/paz booleans must pass before a preview file is returned, while post-export print audit remains informational for the site preview",
