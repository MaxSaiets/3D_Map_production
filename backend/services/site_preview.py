    ...
    result = {
        ...
        "model_logic": {
            **model_logic,
            ...
            "canonical_note": "preview is generated by the same strict full 3D pipeline as production model generation; groove/paz booleans and print acceptance must pass before a preview file is returned",
