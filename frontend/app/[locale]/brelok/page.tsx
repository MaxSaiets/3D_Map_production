...
const HUB: Record<AppLocale, HubCopy> = {
  uk: {
    ...
    description: "3D-брелок із картою будь-якого міста України чи світу: вулиці, будівлі, річки у мініатюрі на жетоні. Ваш район на ключах — персональний подарунок від 170 ₴.",
