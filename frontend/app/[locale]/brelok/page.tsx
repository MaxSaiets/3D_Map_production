...
const HUB: Record<AppLocale, HubCopy> = {
  uk: {
    title: "Брелок з гравіюванням і картою міста — на замовлення від 170 ₴",
    description: "Іменний брелок з гравіюванням: карта вашого району, вулиці чи міста рельєфом і напис — імʼя, дата, «HOME». 3D-друк на замовлення від 170 ₴, доставка Новою Поштою.",
    ...
    faq: [
      ...
      { q: "Скільки коштує брелок?", a: "Базова ціна брелка-жетона — від 170 ₴. Фінальна залежить від формату й напису; точну суму видно перед замовленням." },
