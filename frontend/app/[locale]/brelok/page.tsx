...
const HUB: Record<AppLocale, HubCopy> = {
  uk: {
    ...
    intro: "Мініатюра рідного району на ключах — вулиці, квартали й річки у точному 3D. Оберіть місто нижче або будь-яку точку світу в конструкторі. Друкуємо з еко-PLA й доставляємо Україною та в ЄС.",
  ...
  en: {
    ...
    intro: "A miniature of your neighbourhood on your keys — streets, blocks and rivers in precise 3D. Pick a city below, or any point on Earth in the builder. Printed in eco-PLA and shipped across Ukraine and the EU.",
  ...
  de: {
    ...
    intro: "Eine Miniatur deines Viertels am Schlüsselbund — Straßen, Blocks und Flüsse in präzisem 3D. Wähle unten eine Stadt oder im Konfigurator jeden beliebigen Punkt der Erde. Gedruckt aus Öko-PLA, Versand in die Ukraine und die EU.",
  ...
  pl: {
    ...
    intro: "Miniatura Twojej dzielnicy przy kluczach — ulice, kwartały i rzeki w precyzyjnym 3D. Wybierz miasto poniżej lub dowolny punkt świata w kreatorze. Drukujemy z eko-PLA i wysyłamy na Ukrainę oraz do UE.",
  ...
  fr: {
    ...
    intro: "Une miniature de votre quartier sur vos clés — rues, îlots et rivières en 3D précis. Choisissez une ville ci-dessous, ou n'importe quel point du monde dans le configurateur. Imprimé en PLA écologique, livré en Ukraine et dans l'UE.",
  ...
  es: {
    ...
    intro: "Una miniatura de tu barrio en las llaves — calles, manzanas y ríos en 3D preciso. Elige una ciudad abajo, o cualquier punto del mundo en el configurador. Impreso en PLA ecológico y enviado a Ucrania y la UE.",
