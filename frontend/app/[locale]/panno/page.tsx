...
const COPY: Record<AppLocale, PannoCopy> = {
  uk: {
    ...
    how: [
      ...
      "Замовте друк — виготовимо за 2–4 робочі дні й надішлемо Новою Поштою по Україні.",
    ],
    ...
    faq: [
      ...
      { q: "Скільки коштує і як довго чекати?", a: `Панно 2×2 з плиток 8 см — від ${M[80] * 4} ₴, панно 3×3 — від ${M[80] * 9} ₴. Виготовлення 2–4 робочі дні + доставка Новою Поштою. Оплата карткою онлайн або при отриманні.` },
    ],
  ...
  en: {
    ...
    description: `A wall map built from 3D-printed tiles: pick a district and we assemble a 2×2 or 3×3 panel with streets, blocks and rivers. From ≈€${eur(M[80] * 4)} for a 2×2 panel, shipping across Ukraine.`,
    ...
    how: [
      ...
      "Order the print — made in 2–4 business days and shipped across Ukraine.",
    ],
    ...
    faq: [
      ...
      { q: "Price and lead time?", a: `A 2×2 panel of 8 cm tiles from ≈€${eur(M[80] * 4)}, 3×3 from ≈€${eur(M[80] * 9)}. Production 2–4 business days plus shipping. Card payment online.` },
    ],
  ...
  de: {
    ...
    description: `Wandkarte aus 3D-gedruckten Kacheln: Viertel wählen — wir bauen ein 2×2- oder 3×3-Panel mit Straßen, Blöcken und Flüssen. Ab ≈${eur(M[80] * 4)} € für 2×2, Versand innerhalb der Ukraine.`,
    ...
    how: [
      ...
      "Bestelle den Druck — Fertigung in 2–4 Werktagen, Versand innerhalb der Ukraine.",
    ],
    ...
    faq: [
      ...
      { q: "Preis und Lieferzeit?", a: `2×2-Panel aus 8-cm-Kacheln ab ≈${eur(M[80] * 4)} €, 3×3 ab ≈${eur(M[80] * 9)} €. Fertigung 2–4 Werktage plus Versand. Kartenzahlung online.` },
    ],
  ...
  pl: {
    ...
    description: `Mapa na ścianę z drukowanych kafelków 3D: wybierz dzielnicę — złożymy panel 2×2 lub 3×3 z ulicami, kwartałami i rzekami. Od ≈${eur(M[80] * 4)} € za panel 2×2, wysyłka po Ukrainie.`,
    ...
    how: [
      ...
      "Zamów druk — wykonanie 2–4 dni robocze, wysyłka po Ukrainie.",
    ],
    ...
    faq: [
      ...
      { q: "Cena i czas realizacji?", a: `Panel 2×2 z kafelków 8 cm od ≈${eur(M[80] * 4)} €, 3×3 od ≈${eur(M[80] * 9)} €. Wykonanie 2–4 dni robocze plus wysyłka. Płatność kartą online.` },
    ],
  ...
  fr: {
    ...
    description: `Carte murale en tuiles imprimées en 3D : choisissez un quartier — nous assemblons un panneau 2×2 ou 3×3 avec rues, îlots et rivières. Dès ≈${eur(M[80] * 4)} € le panneau 2×2, livraison en Ukraine.`,
    ...
    how: [
      ...
      "Commandez l'impression — fabrication en 2–4 jours ouvrés, livraison en Ukraine.",
    ],
    ...
    faq: [
      ...
      { q: "Prix et délais ?", a: `Panneau 2×2 en tuiles 8 cm dès ≈${eur(M[80] * 4)} €, 3×3 dès ≈${eur(M[80] * 9)} €. Fabrication 2–4 jours ouvrés plus livraison. Paiement par carte en ligne.` },
    ],
  ...
  es: {
    ...
    description: `Mapa de pared con azulejos impresos en 3D: elige un barrio — montamos un panel 2×2 o 3×3 con calles, manzanas y ríos. Desde ≈${eur(M[80] * 4)} € el panel 2×2, envío dentro de Ucrania.`,
    ...
    how: [
      ...
      "Pide la impresión — fabricación en 2–4 días hábiles, envío dentro de Ucrania.",
    ],
    ...
    faq: [
      ...
      { q: "¿Precio y plazos?", a: `Panel 2×2 de azulejos de 8 cm desde ≈${eur(M[80] * 4)} €, 3×3 desde ≈${eur(M[80] * 9)} €. Fabricación 2–4 días hábiles más envío. Pago con tarjeta online.` },
    ],
