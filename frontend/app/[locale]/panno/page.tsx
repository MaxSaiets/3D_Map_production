...
const COPY: Record<AppLocale, PannoCopy> = {
  ...
  en: {
    ...
    how: [
      ...
      "Order the print — made in 1–3 business days and shipped across Ukraine.",
    ],
  ...
  de: {
    ...
    how: [
      ...
      "Bestelle den Druck — Fertigung in 1–3 Werktagen, Versand innerhalb der Ukraine.",
    ],
  ...
  pl: {
    ...
    how: [
      ...
      "Zamów druk — wykonanie 1–3 dni robocze, wysyłka po Ukrainie.",
    ],
  ...
  fr: {
    ...
    how: [
      ...
      "Commandez l'impression — fabrication en 1–3 jours ouvrés, livraison en Ukraine.",
    ],
  ...
  es: {
    ...
    how: [
      ...
      "Pide la impresión — fabricación en 1–3 días hábiles, envío dentro de Ucrania.",
    ],
