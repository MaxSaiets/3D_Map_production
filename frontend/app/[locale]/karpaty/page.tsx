...
const COPY: Record<AppLocale, KarpatyCopy> = {
  ...
  en: {
    ...
    how: [
      ...
      "Order the print — made in 1–3 business days, shipped across Ukraine.",
    ],
    h2faq: "FAQ",
    faq: [
      ...
      { q: "Price and lead time?", a: `A desk relief map from ≈€${eur(M[80] + R)} (size M, 8 cm). Topo keychain from ≈€${eur(KEYCHAIN_PRICE_UAH)}. Production 1–3 business days, shipping across Ukraine.` },
    ],
  ...
  de: {
    ...
    faq: [
      ...
      { q: "Preis und Lieferzeit?", a: `Tisch-Reliefkarte ab ≈${eur(M[80] + R)} € (Größe M, 8 cm). Topo-Anhänger ab ≈${eur(KEYCHAIN_PRICE_UAH)} €. Fertigung 1–3 Werktage, Versand innerhalb der Ukraine.` },
    ],
  ...
  pl: {
    ...
    faq: [
      ...
      { q: "Cena i termin?", a: `Mapa na biurko z rzeźbą od ≈${eur(M[80] + R)} € (rozmiar M, 8 cm). Brelok topo od ≈${eur(KEYCHAIN_PRICE_UAH)} €. Wykonanie 1–3 dni robocze, wysyłka po Ukrainie.` },
    ],
  ...
  fr: {
    ...
    faq: [
      ...
      { q: "Prix et délais ?", a: `Carte relief de bureau dès ≈${eur(M[80] + R)} € (taille M, 8 cm). Porte-clés topo dès ≈${eur(KEYCHAIN_PRICE_UAH)} €. Fabrication 1–3 jours ouvrés, livraison en Ukraine.` },
    ],
  ...
  es: {
    ...
    faq: [
      ...
      { q: "¿Precio y plazos?", a: `Mapa de escritorio en relieve desde ≈${eur(M[80] + R)} € (talla M, 8 cm). Llavero topo desde ≈${eur(KEYCHAIN_PRICE_UAH)} €. Fabricación 1–3 días hábiles, envío dentro de Ucrania.` },
    ],
