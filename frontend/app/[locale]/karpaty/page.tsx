...
const COPY: Record<AppLocale, KarpatyCopy> = {
  uk: {
    ...
    how: [
      ...
      "Замовте друк — виготовимо за 1–3 робочі дні й надішлемо Новою Поштою по Україні.",
    ],
    ...
    faq: [
      ...
      { q: "Скільки коштує і як швидко?", a: `Настільна рельєфна мапа — від ${M[80] + R} ₴ (розмір M, 8 см). Топо-брелок — від ${KEYCHAIN_PRICE_UAH} ₴. Виготовлення 1–3 робочі дні, доставка Новою Поштою по Україні.` },
    ],
