...
const KEYCHAINS: Record<string, SeoProse> = {
  uk: {
    ...
    p2: "Друкуємо з Eco PLA за 2–4 робочі дні, ціна від 120 ₴. Доставка Новою Поштою по Україні. Пара брелоків-«сердець» з районами двох людей з'єднується як пазл — популярний подарунок для пар.",
  },
  en: {
