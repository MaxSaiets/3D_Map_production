...
const CREATE: Record<string, SeoProse> = {
  ...
  de: {
    ...
    p2: "Das fertige Modell drucken wir aus umweltfreundlichem Eco PLA in Größen von 5,5 bis 15 cm (ab ≈6 €) und versenden es in die Ukraine und in 15 EU-Länder. Du hast einen eigenen 3D-Drucker? Lade die fertige 3MF/STL-Datei herunter und drucke zu Hause.",
  },
  pl: {
    ...
    p2: "Gotowy model drukujemy z ekologicznego bioplastiku Eco PLA w rozmiarach od 5,5 do 15 cm (od ≈6 €) i wysyłamy na Ukrainę oraz do 15 krajów UE. Masz własną drukarkę 3D? Pobierz gotowy plik 3MF/STL i wydrukuj w domu.",
  },
  fr: {
    ...
    p2: "Nous imprimons le modèle fini en Eco PLA écologique, en tailles de 5,5 à 15 cm (à partir de ≈6 €), et l'expédions en Ukraine et dans 15 pays de l'UE. Vous avez votre propre imprimante 3D ? Téléchargez le fichier 3MF/STL prêt et imprimez chez vous.",
  },
  es: {
    ...
    p2: "Imprimimos el modelo terminado en Eco PLA ecológico, en tamaños de 5,5 a 15 cm (desde ≈6 €), y lo enviamos a Ucrania y a 15 países de la UE. ¿Tienes tu propia impresora 3D? Descarga el archivo 3MF/STL listo e imprime en casa.",
  },
};
...
const KEYCHAINS: Record<string, SeoProse> = {
  ...
  de: {
    ...
    p2: "Gedruckt aus Eco PLA in 1–3 Werktagen, ab ≈3 €. Versand in die Ukraine und in EU-Länder. Ein Paar «Herz»-Anhänger mit den Vierteln zweier Menschen fügt sich wie ein Puzzle zusammen — ein beliebtes Geschenk für Paare.",
  },
  pl: {
    ...
    p2: "Drukujemy z Eco PLA w 1–3 dni robocze, od ≈3 €. Wysyłka na Ukrainę i do krajów UE. Para breloków-«serc» z dzielnicami dwóch osób łączy się jak puzzle — popularny prezent dla par.",
  },
  fr: {
    ...
    p2: "Imprimé en Eco PLA en 1 à 3 jours ouvrés, à partir de ≈3 €. Livraison en Ukraine et dans les pays de l'UE. Une paire de porte-clés «cœur» avec les quartiers de deux personnes s'assemble comme un puzzle — un cadeau populaire pour les couples.",
  },
  es: {
    ...
    p2: "Impreso en Eco PLA en 1–3 días hábiles, desde ≈3 €. Envío a Ucrania y a países de la UE. Un par de llaveros «corazón» con los distritos de dos personas encaja como un rompecabezas — un regalo popular para parejas.",
  },
};
...
const CREATE_FAQ: Record<string, ProseFaqItem[]> = {
  ...
  de: [
    ...
    { q: "Wie lange dauert die Herstellung?", a: "1–3 Werktage Druck, dann Versand in die Ukraine oder per Nova Post/Meest in die EU." },
  ...
  pl: [
    ...
    { q: "Ile trwa wykonanie?", a: "1–3 dni robocze na druk, potem wysyłka na Ukrainę lub przez Nova Post/Meest do UE." },
  ...
  fr: [
    ...
    { q: "Combien de temps prend la fabrication ?", a: "1 à 3 jours ouvrés pour l'impression, puis livraison en Ukraine ou via Nova Post/Meest vers l'UE." },
  ...
  es: [
    ...
    { q: "¿Cuánto tarda la fabricación?", a: "1–3 días hábiles de impresión, luego envío a Ucrania o vía Nova Post/Meest a la UE." },
