  ...
  delivery: {
    ...
    sections: [
      { h: "Produits et prix", blocks: [
        { p: "Prix indicatifs (le prix final est visible à l'étape de validation) :" },
        { ul: [
          "Porte-clés-carte — à partir de 120 ₴ (≈ 3 €).",
          "Carte 3D d'un quartier : S 5,5 cm — 250 ₴, M 8 cm — 390 ₴, L 11 cm — 590 ₴, XL 15 cm — 890 ₴ (cartes — à partir de 6 €).",
          "Magnet de réfrigérateur (carte) — 180 ₴.",
